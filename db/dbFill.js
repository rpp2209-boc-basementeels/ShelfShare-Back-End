...
const ordersFill = async () => {
  ...
  try {
    ...
    VALUES('PostgreSQL for dummies', '2022-09-01', 'Educational',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000001);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
  ...
  try {
    ...
    VALUES('Express: That was quick', '2022-09-01', 'Educational',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000002);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
  ...
  try {
    ...
    VALUES('Redux: A Greate State of Mind', '2022-09-01', 'Fiction',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000003);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
  ...
  try {
    ...
    VALUES('Cookies: from Parsing to Ovens', '2022-09-01', 'Cooking',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000004);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
  ...
  try {
    ...
    VALUES('What I learned in boating school is...', '2022-09-01', 'Biography',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000005);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
  ...
  try {
    ...
    VALUES('The Rise and Fall of Limewire', '2022-09-01', 'Non-Fiction',
        'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 'https://bit.ly/3pgkvxA', 9000000000006);`, []);
  } catch (err) {
    console.log('ERROR adding to books TABLE', err);
  }
